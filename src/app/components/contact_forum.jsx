...
export default function Forum() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const eventRef = await addDoc(collection(db, "contacts"), contacts);
  ...
  return (
    <>
      <div className="container mx-auto bg-white shadow-2xl rounded-xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          id="firstName"
                          className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none border dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
