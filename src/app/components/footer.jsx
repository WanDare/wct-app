    ...
    <footer className="bg-white dark:bg-gray-900 mt-14">
      <div className="mx-auto w-full py-6 lg:py-8">
        <div className="md:flex md:justify-between mx-auto w-full max-w-screen-2xl px-6">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-14 sm:grid-cols-4">
            <div>
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <button
                    onClick={() => onClickPage("https://github.com/WanDare")}
                    className="hover:underline "
                  >
                    Github
                  </button>
                ...
                <li>
                  <button
                    onClick={() => onClickPage("https://www.facebook.com")}
                    className="hover:underline"
                  >
                    Facebook
                  </button>
        ...
        <div className="sm:flex sm:items-center sm:justify-between mx-auto w-full max-w-screen-2xl px-6">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <button
              onClick={() => onClickPage("https://discord.com")}
            ...
            <button
              onClick={() => onClickPage("https://twitter.com/?lang=en")}
              className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5"
            >
              <svg
                className="w-4 h-4"
            ...
            <button
              onClick={() => onClickPage("https://dribbble.com")}
              className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5"
            >
              <svg
                className="w-4 h-4"
